...
export const resume: Record<Lang, Resume> = {
  ...
  ca: {
    ...
    education: [
      ...
      { institution: 'Novatecnica, Vila-seca', degree: 'PRL', period: '2026' },
      { institution: 'IDFO', degree: 'Operador de Carretons Elevadors', period: '2024' },
      { institution: 'ESI Valladolid', degree: 'Curs de Disseny Multimèdia i 3D', period: '2020' },
      { institution: 'I.E.S. Vega del Prado', degree: 'CFGS — ICTI', period: '2017 – 2019' },
      { institution: 'Valladolid', degree: 'CFGM — Laboratori d\'Imatge', period: '2008 – 2010' },
      { institution: 'Valladolid', degree: 'E.S.O.', period: '2005 – 2008' },
    ],
    softSkills: [
  ...
  en: {
    ...
    experience: [
      ...
      },
      {
        ...
        highlights: ['Logistics transport ensuring on-time delivery for every shipment'],
      },
      {
        company: 'Uber Eats, Cambrils',
        role: 'Logistics Delivery',
        ...
        highlights: ['Route planning and effective distribution of food orders'],
      },
      {
        company: 'GlovoApp S.L, Cambrils',
        role: 'Logistics Delivery',
    ...
    education: [
      ...
      { institution: 'Novatecnica, Vila-seca', degree: 'Occupational Risk Prevention (PRL)', period: '2026' },
      { institution: 'IDFO', degree: 'Forklift Operator Certificate', period: '2024' },
      { institution: 'ESI Valladolid', degree: 'Multimedia & 3D Design course', period: '2020' },
      { institution: 'I.E.S. Vega del Prado', degree: 'Higher Diploma in ICTI', period: '2017 – 2019' },
      { institution: 'Valladolid', degree: 'Vocational Diploma in Image Lab', period: '2008 – 2010' },
      { institution: 'Valladolid', degree: 'Compulsory Secondary Education (ESO)', period: '2005 – 2008' },
    ],
    softSkills: [
...
export const profiles: Record<ProfileId, Record<Lang, ProfileEntry>> = {
  logistica: {
    es: {
      ...
      description: 'Preparación de pedidos, control de stock y manejo de carretillas en almacén.',
      about:
    ...
    ca: {
      ...
      description: 'Preparació de comandes, control d\'estoc i maneig de carretons a magatzem.',
      about:
    ...
    en: {
      ...
      description: 'Order picking, stock control and forklift operation in warehouse environments.',
      about:
  ...
  fullstack: {
    es: {
      ...
      description: 'Sitios y aplicaciones web con Astro, Nuxt y React, del diseño al despliegue.',
      about:
    ...
    ca: {
      ...
      description: 'Llocs i aplicacions web amb Astro, Nuxt i React, del disseny al desplegament.',
      about:
    ...
    en: {
      ...
      description: 'Websites and apps with Astro, Nuxt and React, from design to deployment.',
      about:
  ...
  generico: {
    es: {
      ...
      description: 'Profesional polivalente con experiencia en atención al público, mantenimiento y almacén.',
      about:
    ...
    ca: {
      ...
      description: 'Professional polivalent amb experiència en atenció al públic, manteniment i magatzem.',
      about:
    ...
    en: {
      ...
      description: 'All-round professional with experience in customer service, maintenance and warehouse.',
      about:
      ...
      experience: [
        ...
        },
        {
          ...
          period: '2025',
          highlights: [
            'Public garden clearing and phytosanitary upkeep.',
          ],
        },
        {
          role: 'Hospitality Assistant',
...
export const services: Record<Lang, { title: string; description: string }[]> = {
  es: [
    {
      title: 'Logística y almacén',
      description: 'Gestión de inventario, carretillas (frontal, retráctil, apiladoras), picking y expedición.',
    },
    {
      title: 'Desarrollo web',
      description: 'Sitios y aplicaciones pequeñas con Astro, Nuxt, React y TypeScript. Portfolios, catálogos y landings.',
    },
    {
    ...
    },
    {
      ...
      description: 'Altas de usuarios, resolución de incidencias y soporte directo.',
    },
  ],
  ca: [
    {
      title: 'Logística i magatzem',
      description: 'Gestió d\'inventari, carretons (frontal, retràctil, apiladors), picking i expedició.',
    },
    {
      title: 'Desenvolupament web',
      description: 'Llocs i petites apps amb Astro, Nuxt, React i TypeScript. Portfolios, catàlegs i landings.',
    },
    {
    ...
    },
    {
      ...
      description: 'Altes d\'usuaris, resolució d\'incidències i suport directe.',
    },
  ],
  en: [
    {
      title: 'Logistics & warehouse',
      description: 'Inventory management, forklifts (counterbalance, reach, stackers), picking and dispatch.',
    },
    {
      title: 'Web development',
      description: 'Small sites and apps with Astro, Nuxt, React and TypeScript. Portfolios, catalogues and landing pages.',
    },
    {
    ...
    },
    {
      ...
      description: 'User registration, incident resolution and direct support.',
    },
  ],
};

export const sections: Record<Lang, { id: string; label: string; title: string; icon: string }[]> = {
  es: [
    { id: 'perfil', label: '01', title: 'Perfil', icon: 'user' },
    { id: 'experiencia', label: '02', title: 'Experiencia', icon: 'briefcase' },
    { id: 'formacion', label: '03', title: 'Formación', icon: 'graduation-cap' },
  ...
  en: [
    ...
    { id: 'formacion', label: '03', title: 'Education', icon: 'graduation-cap' },
    { id: 'skills', label: '04', title: 'Skills', icon: 'sparkles' },
...
export const ui: Record<Lang, UiStrings> = {
  es: {
    ...
    experienceSubtitle: 'Mismos puestos que en el PDF, con el detalle de cada rol.',
    softSkills: 'Soft skills',
    hardSkills: 'Hard skills',
    languages: 'Idiomas',
    additionalTitle: 'Información adicional',
    profilesTitle: 'Perfiles',
    profilesSubtitle: 'Tres enfoques del mismo CV según el puesto al que apliques.',
    viewProfile: 'Ver perfil',
    ctaText: '¿Prefieres el documento clásico? Descarga el PDF o escríbeme directamente.',
    sendEmail: 'Enviar email',
    servicesTitle: 'Servicios',
    servicesSubtitle: 'Lo que hago',
    servicesIntro: 'Estos son los ámbitos en los que puedo aportar desde el primer día.',
  ...
  ca: {
    ...
    experienceSubtitle: 'Els mateixos llocs que al PDF, amb el detall de cada rol.',
    softSkills: 'Soft skills',
    hardSkills: 'Hard skills',
    languages: 'Idiomes',
    additionalTitle: 'Informació addicional',
    profilesTitle: 'Perfils',
    profilesSubtitle: 'Tres enfocaments del mateix CV segons el lloc al qual apliquis.',
    viewProfile: 'Veure perfil',
    ctaText: 'Prefereixes el document clàssic? Descarrega el PDF o escriu-me directament.',
    sendEmail: 'Enviar email',
    servicesTitle: 'Serveis',
    servicesSubtitle: 'Què faig',
    servicesIntro: 'Aquests són els àmbits en què puc aportar des del primer dia.',
  ...
  en: {
    ...
    experienceSubtitle: 'The same roles as the PDF, with the detail of each one.',
    softSkills: 'Soft skills',
    hardSkills: 'Hard skills',
    languages: 'Languages',
    additionalTitle: 'Additional information',
    profilesTitle: 'Profiles',
    profilesSubtitle: 'Three takes on the same CV, depending on the role you are hiring for.',
    viewProfile: 'View profile',
    ctaText: 'Prefer the classic document? Download the PDF or write to me directly.',
